package com.hpy.rentHouse.distributed.Rabbit.aop;
...
public class LogAopAdviseDefine {
    ...
    @Pointcut(value = "execution(* com.hpy.rentHouse.distributed.Rabbit.util..*(..))")
    ...
    public Object doAround(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        logger.info("---方法：{}结束--------结束时间: {} ,耗时：{}",methodName, new Date(),endTime - beginTime);
        return object;
    }
