...
public class MyExceptionHandler {
     ...
     * @return
     */
    @ExceptionHandler(RentUpdateException.class)
    @ResponseBody
    public Message RentUpdateExceptionHandler(RentUpdateException e,HttpServletRequest request){
        logger.error(request.getRequestURI() + ":",e.getMessage());
        return Message.requestFail(ResponseConstant.RENTUPDATEFAILD);
    }
