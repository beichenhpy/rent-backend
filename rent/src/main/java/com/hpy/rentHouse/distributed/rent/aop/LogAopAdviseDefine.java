package com.hpy.rentHouse.distributed.rent.aop;
...
public class LogAopAdviseDefine {
    ...
    @Pointcut(value = "execution(* com.hpy.rentHouse.distributed.rent.service.Impl..*(..)) || " +
            "execution(* com.hpy.rentHouse.distributed.rent.utils..*(..)) ||" +
            "execution(* com.hpy.rentHouse.distributed.rent.controller..*(..))")
