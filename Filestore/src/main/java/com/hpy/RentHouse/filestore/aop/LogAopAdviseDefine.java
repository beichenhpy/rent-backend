package com.hpy.RentHouse.filestore.aop;
...
public class LogAopAdviseDefine {
    ...
    @Pointcut(value = "execution(* com.hpy.RentHouse.filestore.service..*(..)) || " +
            "execution(* com.hpy.RentHouse.filestore.controller..*(..)) ||" +
            "execution(* com.hpy.RentHouse.filestore.util..*(..))")
